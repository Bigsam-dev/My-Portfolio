...
export const sanityConfig={projectId:import.meta.env.PUBLIC_SANITY_PROJECT_ID?.trim()||'flpzrgcs',dataset:import.meta.env.PUBLIC_SANITY_DATASET?.trim()||'production',apiVersion:import.meta.env.PUBLIC_SANITY_API_VERSION?.trim()||'2026-08-31'};
